// src/components/kitchen/KitchenMetrics.tsx

import React from 'react'
import { TrendingUp, TrendingDown, CheckCircle2 } from 'lucide-react'
import type { KitchenMetric } from './types/kitchenTypes'

interface KitchenMetricsProps {
  metrics: KitchenMetric[]
}

const KitchenMetrics: React.FC<KitchenMetricsProps> = ({ metrics }) => {
